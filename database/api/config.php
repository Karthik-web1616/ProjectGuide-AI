...
// Trace AI microservice (docker-compose, port 8001)
// PHP fires a non-blocking POST here after every AI call.
// If the service is down the app keeps working — resilience first.
define('TRACE_SERVICE_URL', 'http://localhost:8001');
